// File: lib/core/constants/app_themes.dart
...
class AppThemes {
  ...
  static const AppThemeData walkmanOrange = AppThemeData(
    ...
    label: 'Walkman Orange', // [F2] no change
  ...
  // [F2] Renamed: "Cyber Black" -> "Deep Black". Enum id (cyberBlack) and
  // all color values are intentionally unchanged — display label only.
  ...
  // [F2] Renamed: "Silver Chrome" -> "Apple Green". Enum id (silverChrome)
  // and all color values are intentionally unchanged — display label only.
